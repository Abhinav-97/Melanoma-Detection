...
parser = parser.add_argument('--num_networks', type=int, default=3, help='Number of networks to train parallely')
...
DEVICE = "TPU"
CFG = dict(
    net_count=args["num_networks"],
    batch_size=args["batch_size"],

    read_size=args["image_size"],
    crop_size=args["image_size"]-4,
    net_size=args["image_size"],
...
GCS_PATH = KaggleDatasets().get_gcs_path('melanoma-%ix%i' % (args["image_size"], args["image_size"]))
...
if DEVICE != "TPU":
    print("Using default stategy for CPU and GPU")
